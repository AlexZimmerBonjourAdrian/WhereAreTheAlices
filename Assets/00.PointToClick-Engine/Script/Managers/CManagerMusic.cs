...
public class CManagerMusic : MonoBehaviour
{
  ...
  public void Awake()
    ...
    if(_inst != null && _inst != this)
        ...
        runner.AddCommandHandler<int>("PlayMusic", PlayMusicBackground); // Added command handler
        runner.AddCommandHandler("StopMusic", StopMusic); // Added command handler
        runner.AddCommandHandler<float>("FadeOutMusic", FadeOut); // Added command handler
        runner.AddCommandHandler<float>("FadeInMusic", FadeIn); // Added command handler
